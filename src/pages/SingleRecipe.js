      ...
      <div className="container my-5">
        <div className="row">
          ...
          <div className="col-10 mx-auto col-md-6 my-3">
            ...
            <h6 className="text-capitalize text-warning text-slanted">provided by {publisher}</h6>
            <a href={publisher_url} target="_blank" rel="noopener noreferrer" className="btn btn-primary text-capitalize mt-2">
              publisher webpage
            </a>
            <a href={source_url} target="_blank" rel="noopener noreferrer" className="btn btn-success text-capitalize mt-2 mx-2">
              recipe url
            </a>
